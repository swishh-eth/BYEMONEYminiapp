        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-white/40">24h Price Movement</p>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-center justify-between">
              ...
              {(canClaim || canRefund) && (
                <button
                  ...
                  className="bg-gradient-to-r from-emerald-500 to-green-500 text-black text-xs font-bold px-4 py-2 rounded-lg disabled:opacity-50"
                >
                  {txState === 'claiming' ? 'Claiming...' : canRefund ? 'Refund' : 'Claim'}
                </button>
              )}
            </div>
          </div>
